...
while true do
    ...
    pushed = commands.exec("execute if block -136 63 -65 oak_button[powered=true]")
    ...
    if pushed then
        ...
        for a, b in pairs(chestcontents) do
            ...
            --check for fire eggs
            if
                (b.name == "iceandfire:dragonegg_red" or b.name == "iceandfire:dragonegg_gray" or
                    b.name == "iceandfire:dragonegg_green" or
                    b.name == "iceandfire:dragonegg_bronze")
             then
                fire = true
            end
            --check for ice eggs
            if
                (b.name == "iceandfire:dragonegg_blue" or b.name == "iceandfire:dragonegg_sapphire" or
                    b.name == "iceandfire:dragonegg_white" or
                    b.name == "iceandfire:dragonegg_silver")
             then
                ice = true
            end
            --check for lightning eggs
            if
                (b.name == "iceandfire:dragonegg_copper" or b.name == "iceandfire:dragonegg_electric" or
                    b.name == "iceandfire:dragonegg_amethyst" or
                    b.name == "iceandfire:dragonegg_black")
             then
                lightning = true
            end
        end
